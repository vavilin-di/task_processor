...
class TestTaskFilter:
    ...
    def test_with_all_fields(self) -> None:
        ...
        assert "created_at_from" in dumped
        assert "created_at_to" in dumped
        assert "started_at_from" in dumped
        assert "started_at_to" in dumped
        assert "finished_at_from" in dumped
        assert "finished_at_to" in dumped
...
class TestDLQMessageCreate:
    ...
    def test_valid_data(self) -> None:
        ...
        assert message.original_routing_key == "task.created"
        assert message.retry_count == 0
        assert message.x_death is None
    ...
    def test_with_x_death(self) -> None:
        ...
        assert message.x_death == x_death
