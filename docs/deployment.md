# Инструкция по развёртыванию async-task-manager

**Проект:** Асинхронный сервис управления задачами на FastAPI + RabbitMQ + PostgreSQL с паттерном Outbox.
...
| `APP_TITLE`               | Название приложения                                                  | `async-task-manager`  |     Нет      |
